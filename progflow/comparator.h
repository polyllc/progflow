...
namespace util {
	...
	public:
		...
		comparatorExpression(bool nested, comparatorExpression& lefthand, comparatorExpression& righthand, comparator sym) : nestedExpression(nested), symbol(sym) {left = &lefthand;right = &righthand;}
